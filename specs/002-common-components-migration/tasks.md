...
**완료 기준**:
- [x] 모든 인터랙티브 컴포넌트에 aria-label이 추가됨
- [x] 스크린 리더가 올바르게 읽을 수 있음
...
**완료 기준**:
- [x] 모든 컴포넌트가 키보드로 접근 가능함
- [x] Tab, Enter, Space, Escape 키가 정상 작동함
...
**완료 기준**:
- [x] 모달이 열릴 때 포커스가 모달 내부로 이동함
- [x] 모달이 닫힐 때 원래 위치로 복귀함
- [x] Tab 키가 모달 내부에서만 순환함
...
**완료 기준**:
- [x] 모든 버튼의 최소 터치 타겟 크기가 44px × 44px 이상
- [x] 모바일 환경에서 터치하기 쉬움
...
**완료 기준**:
- [x] DualButton 컴포넌트의 모든 기능이 정상 작동함
- [x] 테스트 결과 문서화됨
...
**완료 기준**:
- [x] BottomSheet 컴포넌트의 모든 기능이 정상 작동함
- [x] 테스트 결과 문서화됨
...
**완료 기준**:
- [x] TimecapsuleHeader 컴포넌트의 모든 기능이 정상 작동함
- [x] 테스트 결과 문서화됨
...
**완료 기준**:
- [x] Modal 컴포넌트와 Provider의 모든 기능이 정상 작동함
- [x] 테스트 결과 문서화됨
...
**완료 기준**:
- [x] Toast 컴포넌트와 Provider의 모든 기능이 정상 작동함
- [x] 테스트 결과 문서화됨
